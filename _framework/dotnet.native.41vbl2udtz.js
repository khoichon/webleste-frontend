...
var ASM_CONSTS = {
 ...
 1388770: () => Module["SDL3"].audioContext.sampleRate,
 1388821: ($0, $1, $2, $3) => {
  var SDL3 = Module["SDL3"];
 ...
 1394375: () => (navigator.mediaDevices === undefined) ? 0 : 1,
 1394434: ($0, $1, $2, $3, $4, $5, $6) => {
  const device = $0;
  const w = $1;
  const h = $2;
 ...
 1405629: () => window.innerWidth,
 1405659: () => window.innerHeight,
 1405690: $0 => {
